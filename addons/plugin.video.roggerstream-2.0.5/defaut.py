...
def  menus():        		
	...
	dialog.ok("ROGGER STREAM", "          Assistam a vários canais de TV no Kodi.")
...
def  categorias():
	...
	addDir('WEBCAMS BR (EM BREVE)','https://copy.com/nEagWXhOC1s7dlyO?download=1',6,'https://copy.com/dPj2J9AzaExumsnE')
