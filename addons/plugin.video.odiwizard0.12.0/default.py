...
base='http://oditv.com'
ADDON=xbmcaddon.Addon(id='plugin.video.odiwizard')
...
def CATEGORIES():
    link = OPEN_URL('http://ondemandinternettv.com/downloads/odiwiz.txt').replace('\n','').replace('\r','')
...
def wizard(name,url,description):
    ...
    dp.create("Phase 1 of 2","Retrieving Your Selected ODI TV Option",'', 'Please Wait')
    ...
    time.sleep(2)
    dp.update(0,"", "Configuring your ODI TV experience!")
    print '======================================='
    print addonfolder
    print '======================================='
    extract.all(lib,addonfolder,dp)
    dialog = xbmcgui.Dialog()
    dialog.ok("Phase 2 of 2 - Install Complete![COLOR=red] PLEASE NOTE [/COLOR]", 'ODI TV Changes Implemented')
    killxbmc()
        
      
        
def killxbmc():
    choice = xbmcgui.Dialog().yesno('Reboot ODITV Now?', 'In order for changes to take effect, you will need to reboot your device.', 'You must reboot now', nolabel='No, Cancel',yeslabel='Yes, Reboot Now')
    if choice == 0:
        return
    elif choice == 1:
        pass
